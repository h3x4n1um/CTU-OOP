    ...
    private boolean validateHangSoA() {
        ...
        try {
            if (!"".equals(view.getTextFieldA().getText())) {
                ...
                error += "\nHằng số a không được trống.";
            }
        } catch (NumberFormatException ex) {
            ex.printStackTrace();
            error += "\nHằng số a không hợp lệ.";
        }
        return isValid;
    }
    ...
    private boolean validateHangSoB() {
        ...
        try {
            if (!"".equals(view.getTextFieldB().getText())) {
                ...
                error += "\nHằng số b không được trống.";
            }
        } catch (NumberFormatException ex) {
            ex.printStackTrace();
            error += "\nHằng số b không hợp lệ.";
        }
        return isValid;
    }
    ...
    private boolean validateHangSoC() {
        ...
        try {
            if (!"".equals(view.getTextFieldC().getText())) {
                ...
                error += "\nHằng số c không được trống.";
            }
        } catch (NumberFormatException ex) {
            ex.printStackTrace();
            error += "\nHằng số c không hợp lệ.";
        }
        return isValid;
    }
    
    private boolean validateHangSo(){
    	error = new String();
    	boolean isValidA = validateHangSoA();
    	boolean isValidB = validateHangSoB();
    	boolean isValidC = validateHangSoC();
    	boolean isValid = isValidA && isValidB && isValidC;
    	if (!isValid){
