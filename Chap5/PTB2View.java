...
public class PTB2View extends JFrame {
    ...
    public PTB2View() {
        ...
        JLabel labelHangSoA = new JLabel("x^2+");
        JLabel labelHangSoB = new JLabel("x+");
        JLabel labelHangSoC = new JLabel("=0");
        labelHangSo.setBounds(20, 20, 50, 20);
        labelHangSoA.setBounds(50, 50, 40, 20);
        labelHangSoB.setBounds(130, 50, 40, 20);
        labelHangSoC.setBounds(210, 50, 40, 20);
        // tạo các trường nhập hằng số
        textFieldA = new JTextField();
        textFieldB = new JTextField();
        textFieldC = new JTextField();
        textFieldA.setBounds(20, 50, 30, 20);
        textFieldB.setBounds(100, 50, 30, 20);
        textFieldC.setBounds(180, 50, 30, 20);
